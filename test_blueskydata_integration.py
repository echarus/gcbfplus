...
def main():
    ...
    parser.add_argument("--area-size", type=float, default=55)
    parser.add_argument("--max-step", type=int, default=2248)
    parser.add_argument("--path", type=str, default='/home/bayhan/repo_gcbf_jax/uas-collision-avoidance/gcbfplus-main-bluesky/pretrained/DoubleIntegrator/gcbf+')
    ...
    parser.add_argument("--nojit-rollout", action="store_true", default=True)
